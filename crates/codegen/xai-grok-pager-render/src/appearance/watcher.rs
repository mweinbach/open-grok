...
//!
//! In dev mode, watches ~/.opengrok/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.opengrok/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.opengrok/pager.toml, watches for changes
