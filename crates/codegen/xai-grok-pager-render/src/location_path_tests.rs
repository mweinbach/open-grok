...
fn shorten_location_path_kerem_grok_home() {
    assert_eq!(
        shorten_location_path("~/.opengrok/worktrees/code-xai/dashboard-design").as_ref(),
        "~/.o/w/code-xai/dashboard-design"
    );
    assert_eq!(
        shorten_location_path("$OPENGROK_HOME/worktrees/code-xai/dashboard-design").as_ref(),
        "$OPENGROK_HOME/w/code-xai/dashboard-design"
    );
    assert_eq!(
...
fn shorten_location_path_short_paths_leave_alone() {
    ...
    assert_eq!(shorten_location_path("~/.opengrok").as_ref(), "~/.opengrok");
    assert_eq!(
        shorten_location_path("~/.opengrok/worktrees").as_ref(),
        "~/.opengrok/worktrees"
    );
    assert_eq!(
        shorten_location_path("$OPENGROK_HOME").as_ref(),
        "$OPENGROK_HOME"
    );
    assert_eq!(
        shorten_location_path("$OPENGROK_HOME/worktrees").as_ref(),
        "$OPENGROK_HOME/worktrees"
    );
...
fn shorten_location_path_multi_dot_dirs_are_not_traversal() {
    ...
    assert_eq!(shorten_location_component(".."), "..");
    assert_eq!(shorten_location_component("..."), "...");
    assert_eq!(shorten_location_component(".opengrok"), ".o");
...
#[test]
fn shorten_location_path_does_not_eat_home_lookalike() {
    assert_eq!(
        shorten_location_path("$OPENGROK_HOME_BACKUP/a/b/c").as_ref(),
        "$/a/b/c"
    );
    assert_eq!(
