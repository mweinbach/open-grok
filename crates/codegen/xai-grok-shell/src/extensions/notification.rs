...
/// Debug-only observation emitted with a successful v2 capture.
...
pub enum SessionUpdate {
    ...
    MemoryFiles {
        ...
        /// Whether memory is active for this session. Older shells omit it; default `true`.
        #[serde(default = "memory_files_default_true")]
        enabled: bool,
        /// Why memory is off. Only meaningful when `enabled` is false.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        disabled_reason: Option<MemoryDisabledReason>,
        /// Notes are written automatically after turns.
        #[serde(default = "memory_files_default_true")]
...
fn memory_files_default_true() -> bool {
    true
}
