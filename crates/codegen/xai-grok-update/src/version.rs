...
pub const GH_RELEASE_REPO: &str = "chunsi-w/purr-grok";
pub const OPEN_GROK_RELEASE_API_URL: &str =
    "https://api.github.com/repos/chunsi-w/purr-grok/releases/latest";
pub const OPEN_GROK_RELEASE_DOWNLOAD_BASE_URL: &str =
    "https://github.com/chunsi-w/purr-grok/releases";
