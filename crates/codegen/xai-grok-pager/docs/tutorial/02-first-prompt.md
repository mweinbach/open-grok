...
Open Grok is a conversation with an agent that can read your code, run
...
- **`Ctrl+C`** — cancel a running turn once the composer is empty. `Esc` names that key and keeps your draft.
