...
Fear not — your settings, rules, and skills come with you. Open Grok
...
writes the items you selected into your `.opengrok` config. Re-run it anytime.
...
Run **`open-grok inspect`** in a repo to see every rules file, skill, and MCP
