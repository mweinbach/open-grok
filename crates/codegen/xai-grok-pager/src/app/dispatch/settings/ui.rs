...
use super::setters::{
    ...
    set_display_refresh_auto_cadence_inner, set_enter_steers_inner, set_fork_secondary_model_inner,
    set_group_tool_verbs_inner, set_hunk_tracker_mode_inner, set_image_generation_provider_inner,
