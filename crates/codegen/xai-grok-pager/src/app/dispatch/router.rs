...
use super::settings::setters::{
    ...
    set_max_thoughts_width, set_memory_model, set_multiline_mode, set_page_flip_on_send,
    ...
    set_voice_keybind_enabled, set_voice_stt_language, set_web_search_source, set_x_search_enabled,
};
