...
impl WebSearchClient {
    ...
    fn build_request_json(
        ...
        let web_search = rs::WebSearchToolArgs::default()
            ...
            .build()
            .map_err(|e| web_search_error(format!("Failed to build web search tool: {e}")))?;
        let request = rs::CreateResponseArgs::default()
            ...
            .build()
            .map_err(|e| web_search_error(format!("Failed to build request: {e}")))?;
        let mut body = serde_json::to_value(&request)
            .map_err(|e| web_search_error(format!("Failed to serialize request: {e}")))?;
    ...
    pub async fn search(
        ...
        let request = self.build_request_json(query, allowed_domains, excluded_domains)?;
