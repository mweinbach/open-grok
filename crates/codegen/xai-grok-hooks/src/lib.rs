...
//! from dedicated directories (`~/.opengrok/hooks/` and `<git-worktree-root>/.opengrok/hooks/`),
...
//!     Some(Path::new("/home/user/.opengrok/hooks")),
//!     Some(Path::new("/project/.opengrok/hooks")),
//! );
//!
//! for err in &errors {
